...
- **Agent and chat UI:** Unified tool activity, reasoning, search, and Agent workflows; added morphing state icons, high-contrast light and dark themes, rich-text message copying, clearer sidebar titles, and refined live phase layouts.
